...
servicios_registro = ['http://registro1:5002', 'http://registro2:5002']

servicio_principal = 0

usar_registro_principal = True

def check_health(servicio):
    try:
        response = requests.get(f'{servicio}/usuario-comandos/health')
    ...
    while True:
        ...
        for i in range(len(servicios_registro)):
            ...
            if response:
                ...
                reiniciar_contenedor(servicios_registro[i])
